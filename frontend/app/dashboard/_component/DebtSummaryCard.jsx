...
import { ArrowDownLeft, Calendar, CreditCard, User } from "lucide-react";
...
function DebtSummaryCard({ debts: propDebts }) {
  ...
  const debtItems = propDebts && propDebts.length > 0 ? propDebts : defaultDebtItems;
