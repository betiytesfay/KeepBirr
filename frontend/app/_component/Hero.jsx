    ...
    <div className="bg-white text-gray-900 w-full overflow-x-hidden">
      ...
      <section className="pt-8 sm:pt-16 pb-12 sm:pb-16 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 w-full sm:w-auto max-w-xs sm:max-w-none mx-auto">
          <Link
            href="/login"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 sm:px-7 sm:py-3.5 rounded-xl bg-spring text-onyx text-sm sm:text-base font-bold border border-spring shadow-md hover:bg-onyx hover:text-spring hover:border-onyx transition-all duration-200"
          >
          ...
          <Link
            href="/dashboard"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3 sm:px-6 sm:py-3.5 rounded-xl border-2 border-onyx text-onyx text-sm sm:text-base font-semibold hover:bg-spring/20 transition-all duration-200"
          >
        ...
        {/* Highlights List */}
        <div className="mt-6 sm:mt-8 flex flex-wrap items-center justify-center gap-3 sm:gap-6 text-xs sm:text-sm text-gray-600">
      ...
      <section className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-gray-100">
